    ...
    return (
        <Slide background="linear-gradient(135deg, #183d3d 0%, #93b1a6 100%)">
            <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-3xl font-bold text-white">Documentation du déploiement Local<span className='text-sm'>dossier projet — p. 34</span></h2>
            </div>
            <div className="grid grid-cols-2 gap-5 text-left text-sm">
                <div className="space-y-3">
                    ...
                    {[
                        ...
                        <div key={n} as="div" animation="fade-up" className="flex items-center gap-3">
                            ...
                            <p className="text-white font-bold text-lg h-0">{step}</p>
                        </div>
                    ))}
                    <div as="div" animation="fade-up" className="flex flex-col gap-1 pt-2 border-t border-white/10">
